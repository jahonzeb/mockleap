...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-mockleap-temp-secret-key-change-in-production')
DEBUG = env('DEBUG')
...
# Trust reverse proxy SSL header from Render
